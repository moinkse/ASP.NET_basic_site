...
using CarWorkshop.Application.CarWorkshop.Queries.GetAllWorkshops;
...
namespace CarWorkshop.MVC.Controllers
{
    public class CarWorkshopController : Controller
    {
        ...
        [HttpPost]
        [Authorize(Roles = "Owner")]
        public async Task<IActionResult> Create(CreateCarWorkshopCommands command)
        {
            if (!ModelState.IsValid)
            {
                return View(command);
        ...
        public async Task<IActionResult> CreateCarWorkshopService(CreateCarWorkshopServiceCommands command)
        {
            if (!ModelState.IsValid)
            {
